...
function EditWarden() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`${process.env.React_App_Url}/admin/wardens/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      await axios.put(`${process.env.React_App_Url}/admin/wardens/update/`, fd, {
          headers: {
            token: token,
            ...
            <div className="form-group col-md-6 mt-1 ">
                <div className="row d-flex align-items-center">
                  <div className="form-group col-md-5">
                      <div style={{width:"100%"}}>
                        <img src={`${process.env.React_App_Url}/uploads/${formdata.avatar}`} alt={formdata.name} style={{width:"100%"}}/>
                      </div>
                  </div>
